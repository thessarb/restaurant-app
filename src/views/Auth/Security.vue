<template>
        ...
        <ion-content :fullscreen="true">
            <ion-grid>
                ...
                <ion-row>
                    <ion-col>
                        <ion-input color="tertiary" fill="outline" placeholder="Confirm your password" type="password">
                            <ion-icon slot="start" :icon="lockClosed"></ion-icon>
                            <ion-input-password-toggle color="tertiary" slot="end"></ion-input-password-toggle>
                        </ion-input>
                    </ion-col>
                ...
                <ion-row>
                    <ion-col>
                        <ion-button color="tertiary" expand="block">Complete Registration</ion-button>
                    </ion-col>
                </ion-row>
            </ion-grid> 
        </ion-content>
