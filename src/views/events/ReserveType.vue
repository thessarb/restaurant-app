                ...
                <ion-row class="reserve__type--grid">
                        <router-link :to="{ name: 'reserve',params: {id: event.id}}">
                            <ion-col class="reserve__type--col">
                                <ion-card class="reserve__type">
                                    ...
                                    <ion-card-content>
                                    <ion-icon :icon="diamond" size="large"></ion-icon>
                                    </ion-card-content>
                                </ion-card>
                            </ion-col>
                        </router-link>
                        ...
                        <router-link :to="{ name: 'reserve',params: {id: event.id}}">
                            <ion-col class="reserve__type--col">
                                <ion-card class="reserve__type">
                                    <ion-card-header>
                                        <ion-card-title>Standart</ion-card-title>
                                    </ion-card-header>
                                    <ion-card-content>
                                        <ion-icon :icon="ticket" size="large"></ion-icon>
                                    </ion-card-content>
                                </ion-card>
                            </ion-col>
                        </router-link>
